...
export default async function ContactPage() {
  ...
  const dbSlot = catalogBanners?.["lien-he"];
  const hasBanner = !!(
          ...
          {dbSlot?.desktop?.image && (
            <div className="hidden md:block w-full relative">
              <Image
                ...
                alt={dbSlot.desktop.titleLine1 || "Liên hệ - Duky Store"}
                width={1920}
                height={1080}
                sizes="100vw"
          ...
          {dbSlot?.tablet?.image && (
            <div className="hidden sm:block md:hidden w-full relative">
              <Image
                ...
                alt={dbSlot.tablet.titleLine1 || "Liên hệ - Duky Store"}
                width={1024}
                height={576}
                sizes="100vw"
          ...
          {dbSlot?.mobile?.image && (
            <div className="block sm:hidden w-full relative">
              <Image
                ...
                alt={dbSlot.mobile.titleLine1 || "Liên hệ - Duky Store"}
                width={640}
                height={360}
                sizes="100vw"
