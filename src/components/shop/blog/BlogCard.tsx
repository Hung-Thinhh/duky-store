    ...
    return (
      ...
      >
        ...
        <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-sm rounded-xl px-3 py-2 text-center min-w-[52px]">
          <span className="block text-lg font-bold text-white leading-tight">{dateParts.day}</span>
          <span className="block text-[10px] font-semibold uppercase text-gray-300 tracking-wider">{dateParts.month}</span>
        </div>
    ...
    >
      ...
      <div className="relative w-full aspect-[16/10] overflow-hidden bg-gray-100">
        ...
        <div className="absolute top-3 left-3 bg-black/60 backdrop-blur-sm rounded-xl px-3.5 py-2 text-center min-w-[56px]">
          <span className="block text-xl font-bold text-white leading-tight">{dateParts.day}</span>
          <span className="block text-[11px] font-semibold uppercase text-gray-300 tracking-wider">{dateParts.month}</span>
        </div>
      </div>
