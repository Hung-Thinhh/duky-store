      ...
      <div className="container-custom">
        <div className="glass-effect p-4 md:p-8 rounded-[40px] border border-white/40 mt-8">
          <div className="grid grid-cols-1 lg:grid-cols-[450px_1fr] gap-6 lg:gap-8 items-stretch ">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <p className="content text-xs md:text-sm text-gray-600 leading-relaxed">
                    <span className="font-bold text-black">Địa chỉ:</span> số
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="content text-xs md:text-sm text-gray-600">
                    <span className="font-bold text-black">Giờ mở cửa:</span>{" "}
                    09:00 - 21:00
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="content text-xs md:text-sm text-gray-600">
                    <span className="font-bold text-black">Zalo:</span>{" "}
                    0939.654.574
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="content text-xs md:text-sm text-gray-600">
                    <span className="font-bold text-black">Chính sách:</span>{" "}
                    Miễn phí hàng trả trong 3 ngày.
                  </p>
                </div>
              </div>
            ...
            <div className="relative group overflow-hidden rounded-[24px] shadow-2xl min-h-[400px] lg:min-h-full bg-neutral-100 flex items-center justify-center border border-white/20">
              {isMapLoaded ? (
                <iframe
