...
export const GuideSection = () => {
  ...
  React.useEffect(() => {
    if (!lookbookSliderRef.current) return;
    ...
    <section className="pt-24 pb-8 px-6 overflow-hidden">
      <div className="container-custom">
        <div className="glass-effect p-4 mt-8 md:p-8 lg:p-12 overflow-hidden shadow-2xl">
          <div 
            className="w-full max-w-[1380px] relative flex flex-row lg:flex-row items-center justify-between gap-2 lg:gap-0"
          >
          {/* Left Content */}
          <motion.div 
          ...
          >
            ...
            >
              ...
              <ArrowRight size={18} className={cn("transition-transform duration-300 group-hover:translate-x-1", showCalculator && "rotate-90")} />
            </button>
          </motion.div>
                ...
                <React.Fragment key={step.id}>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start w-full justify-start mb-2">
                      <span className="text-2xl font-bold font-accent text-text-main opacity-20">{step.id}</span>
        ...
        <div className="glass-effect p-4 mt-8 md:p-8 lg:p-12 overflow-hidden shadow-2xl">
          ...
          <div className="lookbook-slider-container relative overflow-hidden py-4">
            ...
            >
              {[...LOOKBOOK_IMAGES, ...LOOKBOOK_IMAGES, ...LOOKBOOK_IMAGES].map((img, i) => (
                <motion.div
                  key={`${i}-${img}`}
                  initial={{ opacity: 0 }}
        ...
        <div className="glass-effect p-4 mt-8 md:p-8 lg:p-12 overflow-hidden shadow-2xl relative">
          ...
          <div className="feedback-slider-container relative overflow-hidden py-10">
            <div className="feedback-track flex gap-8 items-center" ref={sliderRef} style={{ width: 'fit-content' }}>
