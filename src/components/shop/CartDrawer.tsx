        ...
        <>
          ...
          >
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="p-2 hover:bg-slate-50 rounded-full text-black cursor-pointer"
              >
                <X size={24} />
              </button>
            </div>
                    ...
                    <div key={item.id} className="flex gap-3">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex justify-between items-start">
                          <h3 className="content font-bold text-black">
                            {item.productName}
                          </h3>
                          <button
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-slate-100 bg-slate-50 space-y-4">
                <div className="flex justify-between text-lg font-bold">
                  ...
                  <span className="content text-lg font-serif text-black">
                    {formatCurrency(total)}
                  </span>
                </div>
                <Button variant="neumorphic-dark" className="w-full py-5">
                  THANH TOÁN NGAY
                </Button>
              </div>
            )}
