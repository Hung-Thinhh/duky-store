...
- Thông báo: *"Email xác nhận đã được gửi đến `<email>`."*
- CTA: "Theo dõi đơn hàng" → `/account/orders/[id]` và "Tiếp tục mua sắm" → `/`.
...
*Xem thêm: `features/cart.md` cho quy trình trước checkout. `features/auth.md` cho bảo vệ route.*
